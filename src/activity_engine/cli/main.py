...
def _cmd_doctor(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        caps = asyncio.get_event_loop().run_until_complete(controller.get_capabilities())
...
def _cmd_monitor(args: argparse.Namespace) -> int:
    """Run a live monitoring loop using mock adapters (safe default)."""
    ...
    print(f"Monitoring started (mode={args.mode}, session={session_id})")
